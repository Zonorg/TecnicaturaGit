/*
Ejercicio 9: pedir el día, mes y año de una fecha e indicar si la fecha es correcta. Suponiendo que todos los meses son de 30 días
 */
package Ciclos09;
        ...
        if((dia != 0) &&(dia <= 30)){
            if((mes != 0) &&(mes <= 12)){
                if((año != 0) && (año <= 2022)){
                    ...
                    System.out.println("Fecha incoreccta, año incorrecto");
                }
            }
            else{
